...

{
  addContent: function addContent(_ref, content) {var commit = _ref.commit,state = _ref.state;
    commit(_mutationTypes.ADD_CONTENT, { content: content });
  },
  updatePageInfo: function updatePageInfo(_ref2) {var commit = _ref2.commit,state = _ref2.state;
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));var _ADD_CONTENT$UPDATE_P;function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = (_ADD_CONTENT$UPDATE_P = {}, _defineProperty(_ADD_CONTENT$UPDATE_P,

_mutationTypes.ADD_CONTENT, function (state, _ref) {var content = _ref.content;
  // console.log(state)
  // console.log(content)
  var len = state.pageInfo.content.length;
